...
export const crises: CrisisDefinition[] = [
  { id: 'heat-dome', name: 'Heat Dome', text: 'Deal 2 damage. -2 Ecology.', effects: [{ kind: 'health', amount: -2 }, { kind: 'index', index: 'ecology', amount: -2 }], calamity: { index: 'coordination', threshold: 3, text: 'Low Coordination adds 2 damage.', effects: [{ kind: 'health', amount: -2 }] } },
  { id: 'aging-water-infrastructure', name: 'Aging Water Infrastructure', text: '-2 Economy, -2 Coordination.', effects: [{ kind: 'index', index: 'economy', amount: -2 }, { kind: 'index', index: 'coordination', amount: -2 }], calamity: { index: 'trust', threshold: 3, text: 'Public confidence fails: add Apathy and lose 1 Trust.', effects: [{ kind: 'index', index: 'trust', amount: -1 }] } },
  { id: 'industrial-pollution-corridor', name: 'Industrial Pollution Corridor', text: 'Add 3 Pollution. -2 Ecology.', effects: [{ kind: 'index', index: 'ecology', amount: -2 }], calamity: { index: 'ecology', threshold: 3, text: 'Ecosystem Collapse.', effects: [{ kind: 'health', amount: -3 }] } },
  { id: 'plastic-waste-surge', name: 'Plastic Waste Surge', text: 'Add 2 Pollution. Deal 2 damage. -1 Ecology, -1 Economy.', effects: [{ kind: 'health', amount: -2 }, { kind: 'index', index: 'ecology', amount: -1 }, { kind: 'index', index: 'economy', amount: -1 }] },
  { id: 'public-burnout', name: 'Public Burnout', text: '-3 Trust. Draw 1 fewer next turn.', effects: [{ kind: 'index', index: 'trust', amount: -3 }], calamity: { index: 'ecology', threshold: 3, text: 'Environmental despair: lose 2 Coordination.', effects: [{ kind: 'index', index: 'coordination', amount: -2 }] } },
  { id: 'deforestation-surge', name: 'Deforestation Surge', text: '-3 Ecology. If untreated, lose 2 Health.', effects: [{ kind: 'index', index: 'ecology', amount: -3 }], calamity: { index: 'economy', threshold: 3, text: 'Economic pressure accelerates logging: lose 2 Trust.', effects: [{ kind: 'index', index: 'trust', amount: -2 }] } },
  { id: 'supply-chain-shock', name: 'Supply Chain Shock', text: '-3 Economy. Technology costs +1 this turn.', effects: [{ kind: 'index', index: 'economy', amount: -3 }], calamity: { index: 'coordination', threshold: 3, text: 'Logistical failure: lose 2 Trust.', effects: [{ kind: 'index', index: 'trust', amount: -2 }] } },
  { id: 'diplomatic-gridlock', name: 'Diplomatic Gridlock', text: '-3 Coordination. Policy costs +1 PP this turn.', effects: [{ kind: 'index', index: 'coordination', amount: -3 }], calamity: { index: 'trust', threshold: 3, text: 'Public distrust stalls negotiations: lose 2 Economy.', effects: [{ kind: 'index', index: 'economy', amount: -2 }] } },
  { id: 'extreme-weather-season', name: 'Extreme Weather Season', text: '-2 Ecology, -1 Economy, -1 Coordination. Deal 2 damage.', effects: [{ kind: 'index', index: 'ecology', amount: -2 }, { kind: 'index', index: 'economy', amount: -1 }, { kind: 'index', index: 'coordination', amount: -1 }, { kind: 'health', amount: -2 }], calamity: { index: 'ecology', threshold: 3, text: 'Ecosystem collapse intensifies storms: deal 3 damage.', effects: [{ kind: 'health', amount: -3 }] } },
  { id: 'misleading-campaign', name: 'Misleading Campaign', text: 'Add Misinformation and Backlash. -2 Trust.', effects: [{ kind: 'index', index: 'trust', amount: -2 }], calamity: { index: 'coordination', threshold: 3, text: 'Institutional failure allows campaign to spread: lose 2 Economy.', effects: [{ kind: 'index', index: 'economy', amount: -2 }] } },
];
