...
export const crises: CrisisDefinition[] = [
  ...
  { id: 'plastic-waste-surge', name: 'Plastic Waste Surge', text: 'Add 2 Pollution. Deal 2 damage.', effects: [{ kind: 'health', amount: -2 }] },
  { id: 'public-burnout', name: 'Public Burnout', text: '-3 Trust. Draw 1 fewer next turn.', effects: [{ kind: 'index', index: 'trust', amount: -3 }] },
  { id: 'deforestation-surge', name: 'Deforestation Surge', text: '-3 Ecology. If untreated, lose 2 Health.', effects: [{ kind: 'index', index: 'ecology', amount: -3 }] },
  ...
  { id: 'extreme-weather-season', name: 'Extreme Weather Season', text: '-2 Ecology, -1 Economy, deal 2 damage.', effects: [{ kind: 'index', index: 'ecology', amount: -2 }, { kind: 'index', index: 'economy', amount: -1 }, { kind: 'health', amount: -2 }] },
